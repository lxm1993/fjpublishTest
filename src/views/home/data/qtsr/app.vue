        ...
        <div class="right">
            ...
            <div class="con">
                <el-table :data="tableData" border style="width: 100%" max-height="580">
                    <el-table-column prop="bh" label="科目编号" width="150"></el-table-column>
                    <el-table-column prop="name" label="科目名称" width="120"></el-table-column>
                    <el-table-column prop="jm" label="科目简名" width="120"></el-table-column>
                    <el-table-column prop="pym" label="拼音码" width="120"></el-table-column>
                    <el-table-column prop="ye" label="期末余额" width="300"></el-table-column>
