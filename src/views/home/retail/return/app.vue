...
<!--dialog start-->
    ...
    <!--dialog end-->
        ...
        <div>
            <el-row>
                ...
                <el-col :span="4" class="kjj">
                    <div><el-button @click="hykDialog = true" v-on:keyup.space="rand">会员卡 F2</el-button></div>
                    <div><el-button>调单 Alt+3</el-button></div>
        ...
        <div class="price-num">
            <ul>
                <li>数量:<span>0</span></li>
                <li>折前金额:<span>0</span></li>
                <li>金额:<span>0</span></li>
                <li>整单优惠:<span>0</span></li>
            </ul>
        </div>
        <div style="float: right;">
            <el-button>促销查看</el-button>
...
<script>
  ...
  //  import drag from '../../../../assets/js/directive/drag.js'
//    import Vue from 'vue'
